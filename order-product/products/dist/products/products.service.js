...
let ProductsService = class ProductsService {
    constructor(ProdcutsModel) {
        this.ProdcutsModel = ProdcutsModel;
    }
    async create(CreateProductsDto) {
        ...
        }, CreateProductsDto, { new: true, upsert: true });
    }
    async findAll() {
...
exports.ProductsService = ProductsService = __decorate([
    ...
    __param(0, (0, mongoose_2.InjectModel)(products_1.Products.name)),
